		...
		<div class="row style"> <!--  -->
			...
			<div class="row style">
				<ul class="style-wrap row"> <!-- 툴바 시작 -->
					...
					<div class="text-style"> <!-- bold, Italic, Underline, StrikeThrough -->
						<ul>
						<li>
							<div class="bold" name="bold">
								<button type="button" class="bold" id="nobg" onclick="document.execCommand('bold')">가</button>
							</div>
							<div class="underline" name="underline">
								<button type="button" class="underline" id="nobg" onclick="document.execCommand('underline')">가</button>
							</div>
							<div class="italic" name="italic">
								<button type="button" class="italic" id="nobg" onclick="document.execCommand('italic')">가</button>
							</div>
							<div class="Strikethrough" name="Strikethrough">
								<button type="button" class="Strikethrough" id="nobg" onclick="document.execCommand('Strikethrough')">가</button>
							</div>
							<div class="color" name="color">
								<button type="button" class="color" id="nobg" onclick="document.execCommand('color')">가</button>
							</div>
							<div class="bgcolor" name="bgcolor">
								<button type="button" class="bgcolor" id="nobg" onclick="document.execCommand('bgcolor')">가</button>
							</div>
						</ul>	
					</div>
					<li>
						<div class="p-style">
							<ul>
							<div class="left"><button type="button" class="left" onclick="document.execCommand('justifyleft')"><i class="fas fa-align-left"
								aria-hidden="true"></i></button></div>
							<div class="center"><button type="button" class="center" onclick="document.execCommand('justifycenter')"><i class="fas fa-align-center"
								aria-hidden="true"></i></button></div>
							<div class="right"><button type="button" class="right" onclick="document.execCommand('justifyright')"><i class="fas fa-align-right"
								aria-hidden="true"></i></button></div>
							</ul>	
						</div>
					</li>
